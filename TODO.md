...
- [x] **USMT Snapshot Backuper (`scripts/backup-profile.ps1`)** — Invokes `scanstate.exe` elevated, stages `USMT.MIG` stores, compresses them to OneDrive output folders, and handles retention count cleanups.
